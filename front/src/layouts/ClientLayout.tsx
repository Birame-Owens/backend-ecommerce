...
import { Search, Bell, ShoppingCart, Home, Grid, Heart, User, X, Menu } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        <div className="flex items-center gap-3 h-16">
          ...
          <div className="flex items-center gap-1 flex-shrink-0">
            <button className="p-2 rounded-xl hover:bg-beige-200 transition-colors hidden sm:flex">
              <Bell className="w-5 h-5 text-muted" strokeWidth={1.5} />
            </button>
            <Link to="/panier" className="relative p-2 rounded-xl hover:bg-beige-200 transition-colors">
            ...
            <Link to="/profil" className="hidden sm:flex p-1.5 rounded-xl hover:bg-beige-200 transition-colors">
...
function BottomNav() {
  ...
  const items = [
    ...
    { to: '/categories', icon: Grid, label: 'Catégories' },
